...
class TestMultipleToolCalls:
    ...
    def test_sequential_tool_calls(self):
        ...
        response, final_messages = execute_tool_loop(
            messages=messages,
            model="openai:gpt-4o-mini",
            tools=[get_weather, simple_calculator]
        )
...
class TestConfusingPrompts:
    ...
    def test_contradictory_instructions(self):
        ...
        print(f"✓ Contradictory instructions handled")
    ...
    def test_partial_information(self):
        ...
        print(f"✓ Partial information handled")
...
class TestParameterCombinations:
    ...
    def test_low_temperature_with_tools(self):
        ...
        assert response is not None
        print(f"✓ Low temperature: Response generated")
    ...
    def test_with_response_format_no_tools(self):
        ...
        response = completion(
            messages=messages,
            model="openai:gpt-4o-mini",
            response_format=StructuredAnalysis
        )
...
class TestStressScenarios:
    ...
    def test_rapid_tool_switching(self):
        ...
        messages = [
            ...
            {"role": "user", "content": "Get weather for NYC, then calculate 5+3, then search for 'news', then get weather for LA"}
        ]
    ...
    def test_max_iterations_reached(self):
        ...
        print(f"✓ Max iterations: Stopped after limit")
...
class TestErrorHandling:
    ...
    def test_tool_with_no_description(self):
        ...
        try:
            ...
            print(f"✓ Undocumented tool: Handled")
        except Exception as e:
...
class TestRealisticScenarios:
    ...
    def test_customer_service_scenario(self):
        ...
        messages = [
            ...
            {"role": "user", "content": "Hi, I'm user #CS-456 and I want to know the weather at my location and search for 'return policy'"}
        ]
