...
def example_tool_error_handling():
    ...
    try:
        ...
        result = client.complete("Use risky_tool with value -5")
...
def example_with_retry_visibility():
...
def example_catching_specific_errors():
...
def example_checking_error_details():
    ...
    try:
        result = client.complete("Use buggy_tool to divide 10 by 0")
...
if __name__ == "__main__":
    ...
    try:
        example_with_retry_visibility()
    except Exception as e:
        print(f"Example failed (expected if no API key): {e}")
    
    try:
        example_catching_specific_errors()
    except Exception as e:
        print(f"Example failed (expected if no API key): {e}")
    
    try:
        example_checking_error_details()
    except Exception as e:
        print(f"Example failed (expected if no API key): {e}")
