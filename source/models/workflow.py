...
class CriticConfig(BaseModel):
    ...
    Example:
        ...
        >>> from source.models.workflow import CriticConfig
        >>>
...
class IterativeConfig(BaseModel):
    ...
    Example:
        >>> from source.models.workflow import IterativeConfig
        >>>
...
def _rebuild_models():
    ...
    try:
        from source.executors._base import Executor  # noqa: F401
