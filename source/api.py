...
def _safe_llm_call(
    ...
    This wraps the any_llm_completion call to catch and classify errors.
    Raises our custom exception types for better error handling.
    """
    try:
        return any_llm_completion(
            messages=messages,
            model=model,
...
class ToolExecutionResult(BaseModel):
    ...
    raw_response: Annotated[Optional[SkipValidation[ChatCompletion]], Field(description="The raw final response from the LLM", default=None)]
